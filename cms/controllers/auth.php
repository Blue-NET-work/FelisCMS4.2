...
class Auth extends CI_Controller {
	...
	function edit_group($id)
	{
		...
		$this->data['group_name'] = array(
			...
			'id'    => 'group_name',
			'type'  => 'text',
			'value' => $this->form_validation->set_value('group_name', $group->ug_name),
		);
		$this->data['group_description'] = array(
			'name'  => 'group_description',
			'id'    => 'group_description',
			'type'  => 'text',
			'value' => $this->form_validation->set_value('group_description', $group->ug_description),
		);
	...
	public function provider_endpoint()
	{
		...
		require_once BASEPATH.'/third_party/hybridauth/index.php';
	}
