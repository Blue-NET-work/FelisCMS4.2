<?php
  class Przelewy24 extends CI_Model{

    public function __construct(){
        parent::__construct();
    }

// przelewy24 weryfijacja płatności
    public static function weryfikuj($p24_id_sprzedawcy, $p24_session_id, $p24_order_id, $p24_crc, $p24_kwota=""){
