...
|
*/
$config['encryption_key'] = 'FelisCMS4_Blue-NET';
...
$config['sess_valid_drivers']	= array('native', 'cookie');
$config['sess_cookie_name']		= 'felis_session';
...
$config['sess_time_to_update']	= 3300;
