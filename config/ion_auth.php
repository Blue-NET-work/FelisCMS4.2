...
|   CodeIgnixter MongoDB Active Record Library - http://github.com/alexbilbie/codeigniter-mongodb-library/tree/v2
...
$config['identity_1']                 = 'email'; 		 // A database column which is used to login with
