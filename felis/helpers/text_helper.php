...
if ( ! function_exists('convert_accented_characters'))
{
	...
	function convert_accented_characters($str)
	{
		...
		{
			if (file_exists(ROOTPATH.'config/foreign_chars.php'))
			{
				include(ROOTPATH.'config/foreign_chars.php');
			}

			if (file_exists(ROOTPATH.'config/'.ENVIRONMENT.'/foreign_chars.php'))
			{
				include(ROOTPATH.'config/'.ENVIRONMENT.'/foreign_chars.php');
			}
