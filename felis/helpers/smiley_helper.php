...
if ( ! function_exists('_get_smiley_array'))
{
	...
	function _get_smiley_array()
	{
		...
		if ( ! is_array($smileys))
		{
			if (file_exists(ROOTPATH.'config/smileys.php'))
			{
				include(ROOTPATH.'config/smileys.php');
			}

			if (file_exists(ROOTPATH.'config/'.ENVIRONMENT.'/smileys.php'))
			{
				include(ROOTPATH.'config/'.ENVIRONMENT.'/smileys.php');
			}
