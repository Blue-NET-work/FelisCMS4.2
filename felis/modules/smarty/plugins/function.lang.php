...
{               
        ...
        $_lang = isset($params['lang']) ? $params['lang'] : $_lang;
        $_file = isset($params['file']) ? $params['file'] : '';
        $_line = isset($params['line']) ? $params['line'] : '';  
        $_vars = isset($params['vars']) ? $params['vars'] : ''; 
        ...
        if (substr($_vars, 0, 1) == '$')
        {
            $_vars = $smarty->get_template_vars( substr($_vars, 1) );
        }
        /*
