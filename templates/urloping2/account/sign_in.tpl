	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-5">
				...
				<form class="form-horizontal m-t-20" id="logowanie" action="{$base_url}zaloguj.html" role="form" method="POST">
			...
			<div class="col-md-5 col-md-offset-2">
				...
				<form class="form-horizontal m-t-20" id="logowanie" action="{$base_url}rejestracja.html" role="form" method="POST">
					<!-- pole -->
					<div class="form-group">
