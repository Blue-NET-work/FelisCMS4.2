...
HI.optInCookies = {
	...
	l10n: {
		agree: "Tak",
		agreeCaption: "Tak, zaakceptuj",
		disagree: "Nie",
		disagreeCaption: "Nie, zabierz mnie stad",
		queryBody: "Strona wykorzystuje ciasteczka\ndo przechowywania informacji\nna Twoim komputerze.",
		queryTail: "Czy chcesz zaakceptowac?",
		queryTitle: "Polityka Cookies",
	...
	showQuery: function() {
		...
		//acknowledgement.innerHTML =	'Powered by<br /><a href="http://www.heartinternet.co.uk/" title="Web Hosting">Heart Internet</a>'
