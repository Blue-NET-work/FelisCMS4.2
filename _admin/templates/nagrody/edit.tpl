...
<body class="clearfix with-menu">
    ...
    <section role="main" id="main">
        <section id="mainContent">
            ...
            ================================================== -->
            <header>
                <h1 class="title"><i class="fa fa-2x fa-pencil"></i>  Edycja nagrody</h1>
                <ul class="breadcrumb unstyled-list">
                  <li><a href="#">{lang line="default_control_panel"}</a></li>
                  <li class="active">Edycja nagrody</li>
                </ul>
            </header>
            ...
            <div class="panel panel-black" id="panel">
              <div class="panel-heading">
                ...
                <div class="absolute-right">
                    <ul class="nav nav-tabs" id="navTabs">
                        ...
                        <li><a href="#atrib" data-toggle="tab" class="panel-link">Atrybuty</a></li>
              ...
              <div id="panel-body" class="panel-body in">
                    {include file="nagrody/_NagrodyForm.tpl"}
              </div>
            </div>
            <!-- panel -->
