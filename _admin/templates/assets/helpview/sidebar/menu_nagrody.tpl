    <li class="with-right-arrow">
        ...
        <ul class="big-menu">
            ...
            <li><a href="{$base_url}nagrody/zamowione.html" {if $uri[1]=="nagrody" AND $uri[2]=="zamowione"}class="current navigable-current"{/if}><i class="fa fa-shopping-cart"></i>Zamówione</a></li>
        </ul>
    </li>