    ...
    <section role="main" id="main">
        <section id="mainContent">
           ...
           <!-- TOP
            ...
            ================================================== -->
            <header>
                <h1 class="title"><i class="fa fa-2x fa-list"></i>  {lang line='users_you'}</h1>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group block-label">
                                ...
                                <input type="text" name="item[username]" id="item[username]" class="input form-control" value="{$user->username}">
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                          <div class="fileinput-new thumbnail" style="max-width: 150px; max-height: 150px;">
                                            {if $user->avatar !=""}
                                            <img src="{$base_url}../uploads/avatar/{$user->avatar}" alt="{$user->avatar}">
                                            {else}
                                            <img src="{$base_url}../uploads/avatar/avatar_none.png" alt="avatar">
                                            {/if}
                                          </div>
